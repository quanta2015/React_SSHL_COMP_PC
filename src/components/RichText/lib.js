...
const _CD_LINE = [
  ...
  {
    key: 'cdli015',
    data: "<div class='fn-cd_li_15'><div class='m-bd'><div>中国互联网企业100强榜单主要参考互联网企业年度发展数据，评价指标既覆盖收入、利润、人力资本等财务指标，也覆盖流量、活跃用户数等业务指标。数据统计采用了计算复合指标的方法，计算得出各家企业在企业规模、社会影响、发展潜力和社会责任四个维度上的得分，加权平均后确定排名。</div></div></div>",
  },
  {
    key: 'cdli016',
